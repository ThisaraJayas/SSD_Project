...
exports.getRepliesByMessageId = async (req, res) => {
    try {
        const messageId = req.params.messageId;
        const replies = await MessageReply.find({ message: messageId }).populate('user').populate({path:'message', populate:{path:'user'}});
